...
const About_m = () => {
  return (
    <>
      <SEO
        title="About Us"
        description="Meet the ThermalStar Material Suggestor team. Our material engineers and developers are dedicated to helping you find the best construction materials."
        keywords="ThermalStar team, material engineers, about us, construction experts, material suggestor developers"
        url="https://thermalstar-materialsuggestor.netlify.app/About_m"
      />
      <h2>
